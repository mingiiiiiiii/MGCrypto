...
#define ALGO_AES192 102
#define ALGO_AES256 103
#define ALGO_ARIA128 2
#define ALGO_ARIA192 3
#define ALGO_ARIA256 4

//------------------------------------------------
#define ALGO_AES128_OUTLEN_IN_BYTES 16
#define ALGO_AES192_OUTLEN_IN_BYTES 16
#define ALGO_AES256_OUTLEN_IN_BYTES 16
...
//------------------------------------------------
#define ALGO_AES128_KEYLEN_IN_BYTES 16
#define ALGO_AES192_KEYLEN_IN_BYTES 24
#define ALGO_AES256_KEYLEN_IN_BYTES 32
...
//------------------------------------------------
#define ALGO_AES128_SECURITY_STRENGTH_IN_BYTES 16
#define ALGO_AES192_SECURITY_STRENGTH_IN_BYTES 24
#define ALGO_AES256_SECURITY_STRENGTH_IN_BYTES 32
...
//------------------------------------------------
#define ALGO_AES128_SEEDLEN_IN_BYTES ALGO_AES128_OUTLEN_IN_BYTES + ALGO_AES128_KEYLEN_IN_BYTES
#define ALGO_AES192_SEEDLEN_IN_BYTES ALGO_AES192_OUTLEN_IN_BYTES + ALGO_AES192_KEYLEN_IN_BYTES
#define ALGO_AES256_SEEDLEN_IN_BYTES ALGO_AES256_OUTLEN_IN_BYTES + ALGO_AES256_KEYLEN_IN_BYTES
