...
SINT GF2N_init_ECPT_AC(GF2N_ECPT_AC* ecpt,
                       GF2N_ECPT_AC_BUF* ecpt_buf) {
...
SINT GF2N_add_ECPT_AC(GF2N_EC_CTX* ec_ctx,
                      GF2N_ECPT_AC* a,
                      GF2N_ECPT_AC* b,
                      GF2N_ECPT_AC* r) {
    // affine addition
...
SINT GF2N_dbl_ECPT_AC(GF2N_EC_CTX* ec_ctx,
                      GF2N_ECPT_AC* p1,
                      GF2N_ECPT_AC* p3) {
    // affine doubling
    SINT i, top;
...
SINT GF2N_smul_ECPT_AC(GF2N_EC_CTX* ec_ctx,
                       MPZ* n,
                       GF2N_ECPT_AC* pt,
                       GF2N_ECPT_AC* r) {
    GF2N rx, ry;
